...
from src.coniliation import Sourcer, Conciliator, get_source_path
...
try:
    report_063 = conciliate(ldgr_src, c4b_src, check_txns)
    base_063  = report_063.base_match(gfb_data, c4b_data)
    diffs_063 = report_063.filter_checks(base_063, '~valida')
    fpsl_063  = report_063.filter_checks(base_063, ['gfb', 'indeterminada'])
